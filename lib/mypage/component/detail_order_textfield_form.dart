...
class _DetailOrderTextFieldFormState extends State<DetailOrderTextFieldForm> {
  ...
  Widget titleTextField(String title, String? option){
    final titleStyle = TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: GRAY_4_COLOR,);
    final optionStyle = TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: GRAY_2_COLOR,);
  ...
  Widget purpleOutlinedField(int maxLine, String hintText, TextEditingController controller){
    return Container(

...
class _OrderListTabState extends State<OrderListTab> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return BodyTab(tabTitle: LargeDetailBar(title: "요청목록", moveTo: OrderListScreen(sellProductList: sellProductList, orderProductList: orderProductList)),
      tabBarViewChild: [sellProductCardSlider(productList: sellProductList), orderProductCardSlider(productList: orderProductList)],
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: ClipRect(child: Image.asset(productImg, width: 165.0, height: 165.0, ),)),
                    Text(productName, style: orderProductTextStyle,),
                    Text(orderDate, style: orderDateTextStyle,)
                  ]
              ),
            )
        ),

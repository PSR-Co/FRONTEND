...
class _NotificationListScreenState extends State<NotificationListScreen> {
  ...
  List<NotiList> notiList1 = [
    NotiList("상품명1", "000님의 요청을 확인하세요!"),
  ];
  List<NotiList> notiList2 = [
    NotiList("상품명2", "000님의 요청을 확인하세요!"),
    NotiList("상품명3", "000님의 요청을 확인하세요!"),
  ];
  List<NotiList> notiList3 = [
    NotiList("상품명4", "000님의 요청을 확인하세요!"),
    NotiList("상품명5", "000님의 요청을 확인하세요!"),
    NotiList("상품명6", "000님의 요청을 확인하세요!"),
  ];
  List<NotiList> notiList4 = [
    NotiList("상품명7", "000님의 요청을 확인하세요!"),
    NotiList("상품명8", "000님의 요청을 확인하세요!"),
    NotiList("상품명9", "000님의 요청을 확인하세요!"),
    NotiList("상품명10", "000님의 요청을 확인하세요!")
  ];
                ...
                .map((e) => Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ListView.builder(
                            physics:
                                const NeverScrollableScrollPhysics(), //스크롤 막기
                              ...
                              return ListTile(
                                ...
                                title: GestureDetector(
                                    child: notificationListItem(
                                        e.notiList[index].productName,
                                        e.notiList[index].content)),

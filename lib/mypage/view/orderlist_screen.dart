...
class OrderListScreen extends StatefulWidget {
  ...
  OrderListScreen(
      {required this.sellProductList, required this.orderProductList, Key? key})
      : super(key: key);
...
class _OrderListScreenState extends State<OrderListScreen> {
  final TextStyle ordererNameTextStyle = const TextStyle(
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: BodyTab(
            ...
            tabBarViewChild: [
              sellProductView(widget.sellProductList),
              orderProductView(widget.orderProductList)
            ]),
      ),
    );
  }
  ...
  Widget sellProductView(List<SellProduct> sellProductList) {
    return orderView(ListView.builder(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '요청자 ${sellProductList[index].ordererName}님',
                            style: ordererNameTextStyle,
                          ),
                          Text(
                            sellProductList[index].orderDate,
                            style: dateTextStyle,
                          ),
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: LargeDetailBar(
                          ...
                          moveTo: SellerDetailOrderSccreen(
                            selectedValue: selectedValue,
                            orderDate: sellProductList[index].orderDate,
                            productName: sellProductList[index].productName,
                            btnOption1: '요청승인',
                            btnOption2: '요청거절',
                          )),
    ...
    return orderView(ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          Order orderList = Order(
              orderProductList[index].sellerName,
              orderProductList[index].productIdx,
              orderProductList[index].productName,
              "",
              orderProductList[index].orderDate,
              false);
                  ...
                  child: Column(children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '요청자 ${orderProductList[index].sellerName}님',
                            style: ordererNameTextStyle,
                          ),
                          Text(
                            orderProductList[index].orderDate,
